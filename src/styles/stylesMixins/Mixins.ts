...
import { BorderMixType, FlexMixType, MarginMixType, PaddingMixType, PostionMixType, ShadowMixType, SizeMixType, TextMixType, ViewBoxType } from '../../types/mixinTypes';

export const flexMixin: CSSProp = css<FlexMixType>`
  ${({flex}) => (flex ? `flex: ${flex};` : '')}
  ${({justifyContent}) =>
...
`;
export const paddingMixin: CSSProp = css<PaddingMixType>`
...
`;
export const marginMixin: CSSProp = css<MarginMixType>`
...
`;
export const borderMixin: CSSProp = css<BorderMixType>`
  ...
  ${({borderBottomRightRadius}) =>
    borderBottomRightRadius
      ...
      : ''};
`;
export const sizesMixin: CSSProp = css<SizeMixType>`
...
`;
export const shadowMixin: CSSProp = css<ShadowMixType>`
...
`;
export const textMixin: CSSProp = css<TextMixType>`
  ${({textTransform}) =>
...
`;
export const positionMixin: CSSProp = css<PostionMixType>`
...
`;
export const viewBoxMixin: CSSProp = css<ViewBoxType>`
  ${({backgroundColor}) =>
